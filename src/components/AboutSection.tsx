...
const highlights = [
  ...
  { icon: Palette, label: 'Creative Design', description: 'Crafting beautiful user experiences' },
  { icon: Zap, label: 'Fast Delivery', description: 'Efficient and timely project completion' },
  { icon: Heart, label: 'Passionate', description: 'Dedicated to continuous learning' },
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                I'm a full-stack developer and designer based in San Francisco, with a passion 
                for creating beautiful, functional, and user-centered digital experiences.
              </p>
              <p>
                With over 5 years of experience in the tech industry, I've had the privilege 
                of working with startups and established companies alike, helping them bring 
